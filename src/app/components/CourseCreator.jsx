...
const TestTool = () => {
  ...
  const imageSamples = [
    "/images/coursecreator/Sherlock.jpeg",
    "/images/coursecreator/Codingo.jpeg",
    "/images/coursecreator/Imara.jpeg",
    "/images/coursecreator/Captain.jpeg",
  ];
  useEffect(() => {
      setIsLoaded(true);
  }, []);
  ...
  const handleGenerate = async () => {
    ...
    if (clickedItem !== "") {
      if (clickedItem.includes("Sherlock") || clickedItem.includes("Captain")) {
    ...
    if (data.toLowerCase().includes("harassment")){
      alert("Please enter an appropriate prompt.")
    }
    else{
      setOutput(data)
    }
      ...
      <div className="w-[40vw] px-5 md:px-14 pt-9 pb-24 bg-black border-r text-white border-[#A1A1A1] h-[calc(100vh-182px)]  overflow-y-auto scrollbar" >
        <div className="flex space-x-2">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p >Create a course from text prompt</p>
        </div>
        <div className="relative mt-6" >
        <textarea maxLength='500' className='placeholder:text-white placeholder:text-opacity-60 max-sm:text-sm   h-[250px] resize-none  border-2 border-[#A1A1A1] rounded-lg w-full p-4  bg-black text-lg scrollbar'
              type='text'
              onChange={e=>setText(e.target.value)}
              value={text}
              placeholder='For example: Create a course on hello world in python'
              disabled={!isLoaded}
            />
        ...
        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <p>Choose instructor of your choice</p>
        </div>
        <div
          className={`mt-6 h-[404px] justify-center flex ` + "hidden"}
        ...
        <div className="relative grid gap-4 md:grid-cols-2 mt-7 ">
          {imageSamples.slice(0, imgRow * 2).map((item, index) => {
            return (
              <div key={index} className="flex justify-center">
                <img
                  ...
                  src={item}
                  alt="sample"
                  className={`object-cover  rounded-xl cursor-pointer hover:brightness-100  ${
          ...
          {imageSamples.length > 4 && (
            <div className="absolute bottom-0 flex justify-center w-full ">
              <button
                ...
                onClick={() => {
                  imgRow === 2
                    ? setImgRow(Math.ceil(imageSamples.length / 2))
                    : setImgRow(2);
                }}
              >
...
{/* GENERATE BUTTON */}
        <div className=' fixed bottom-0 z-10 w-full lg:w-[40%]  px-5 md:px-14 py-7 border-t border-r  border-[#A1A1A1] bg-black'>
...
{/* OUTPUT */}
      <div className="bg-[#141718] w-[60vw] h-[calc(100vh-78px)] overflow-y-auto  px-5 md:px-14 py-9 max-lg:pb-20  border-r text-white scrollbar">
